...
The repository is prepared for the **v0.7 Expansion Platform** release on the preserved v0.6 Quality & Reliability baseline. The runtime version is `v0.7`; publishing operations remain separately controlled.
...
1. [MASTER_DESIGN.md](./docs/MASTER_DESIGN.md) — canonical design through v0.7
...
8. [ROADMAP.md](./docs/ROADMAP.md) — overall version boundaries
9. [CHANGELOG.md](./CHANGELOG.md) and release notes — historical change records
...
The 68-test suite verifies the complete preserved v0.6 behavior plus the v0.7 common interface, Registry, Loader, Manager, Expansion API, exact-version rules, lifecycle failure isolation, and Living OS interface boundary. GitHub Actions is configured to run compile and regression checks on Python 3.10 and 3.13.

## Explicit exclusions

The following are not implemented or expanded in v0.7:
...
├─ expansion/                 # v0.7 Expansion Platform
